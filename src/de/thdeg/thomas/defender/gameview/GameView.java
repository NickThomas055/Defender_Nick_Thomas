package de.thdeg.thomas.defender.gameview;
...
public class GameView {
    ...
    /**
     * Checks if the timer that belongs to the given <code>true</code> already has expired. This method returns
     * <code>true</code>, if the timer has never been set. This means this method can be called, even before the
     * timer has been set.
     *
     * @param name     The identifier of the timer to be checked.
     * @param objectID The id of the object that issued this request. This id should be unique for this object.
     * @return <code>true</code>, if timer has expired. It also is <code>true</code>, if timer has not never been set.
     */
